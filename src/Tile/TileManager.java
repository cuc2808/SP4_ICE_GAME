...
public class TileManager {
    ...
    public void getTileImage() {
        ...
        if (!Objects.equals(mapName, "/tile/maps/BlueMap")) {
            try {
                tile[0] = new Tile();
                ...
                tile[29] = new Tile();
                tile[29].image = ImageIO.read(getClass().getResourceAsStream("/tile/tiles/virus.png"));
                ...
                tile[34] = new Tile();
                tile[34].image = ImageIO.read(getClass().getResourceAsStream("/tile/Tiles/blueMapTiles/103.png"));
                tile[34].collision = true;

            } catch (IOException e) {
                e.printStackTrace();
            }
        } else if (mapName.equals("/tile/maps/BlueMap")) {
            ...
            for (int i = 0; i < 130; i++) {
                ...
                if (!solidBlocks.contains(i)) {
                    try {
                        tile[i] = new Tile();
                        tile[i].image = ImageIO.read(getClass().getResourceAsStream("/tile/tiles/blueMapTiles/" + i + ".png"));
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
            ...
            try {
                tile[131] = new Tile();
                tile[131].image = ImageIO.read(getClass().getResourceAsStream("/tile/tiles/portal.jpg"));
            } catch (IOException e) {
        ...
        for (int row = 0; row < gp.maxWorldRow; row++) {
            for (int col = 0; col < gp.maxWorldCol; col++) {
                ...
                if (tile[tileNum] == null) {
                    System.err.println("Warning: Tile " + tileNum + " at row=" + row + ", col=" + col + " is not defined!");
